  ...
  const statCards = [
    {
      ...
      icon: Users,
      color: "bg-blue-500",
      subtitle: `${stats?.total_players || 0} joueurs, ${
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center py-2 border-b border-gray-700">
              ...
              <span className="font-semibold text-white">
                {stats?.total_matches > 0
                  ? Math.round(
                      (stats.confirmed_matches / stats.total_matches) * 100
                    )
                  : 0}
                %
              </span>
            ...
            <div className="flex justify-between items-center py-2 border-b border-gray-700">
              ...
              <span className="font-semibold text-white">
                {stats?.total_managers > 0
                  ? Math.round(
                      (stats.total_players / stats.total_managers) * 10
                    ) / 10
            ...
            <div className="flex justify-between items-center py-2">
              ...
              <span className="font-semibold text-white">
                {stats?.total_users > 0
                  ? Math.round((stats.total_teams / stats.total_users) * 10) /
                    10
                  : 0}
              </span>
            </div>
              ...
              recentReports.map((report) => (
                ...
                >
                  ...
                  <p className="text-sm text-gray-400">
                    Par: {report.reporter_first_name}{" "}
                    {report.reporter_last_name}
                  </p>
                  {report.reported_first_name && (
                    <p className="text-sm text-gray-400">
                      Concernant: {report.reported_first_name}{" "}
